...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        use_reflection (Optional[bool]): Enable reflection during training (GRPO only). None uses default behavior.
        use_reflection_in_validation (Optional[bool]): Enable reflection during validation even if training
            reflection is disabled. None follows use_reflection.
    ...
    use_reflection_in_validation: Optional[bool] = None
